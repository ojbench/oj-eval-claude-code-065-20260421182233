...
bool check(Allocator& allocator) {
    // Condition: (usedBlocks - 1) * 4096 / sizeof(int) / 2 < maxUsedSpace
    // This seems to be a rough check for space efficiency.
    std::cout << "usedBlocks: " << usedBlocks << ", maxUsedSpace: " << maxUsedSpace << std::endl;
